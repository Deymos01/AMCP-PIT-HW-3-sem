...
#define вытолкнуть pop
#define втолкнуть push
#define вершина top
#define пусто empty
#define замерить size

#define короб vector
#define двоица pair
#define череда queue
#define стопка stack
#define хроника unordered_map

#define такой first
#define другой second
